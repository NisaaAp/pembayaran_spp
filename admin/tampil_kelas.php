...
<main>
    ...
    <form action = "tampil_kelas.php" method = "POST">
        <input type = "text" name = "cari" class = "form-control" placeholder = "Masukkan NISN\Nama Kelas"/>
    </form>
    <br>
    <a href="tambah_kelas.php" class="btn btn-secondary">Tambah Kelas</a>
    <br><br>
  ...
  <tbody>
    ...
    if (isset($_POST["cari"])){
        ...
        $cari = $_POST['cari'];//isi nisn/id yang kita cari
    ...
    while ($data_kelas = mysqli_fetch_array($query_kelas)){?>
        <tr> 
            ...
            href="hapusKelas.php?id_kelas=<?=$data_kelas['id_kelas']?>"
