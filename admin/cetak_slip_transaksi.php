...
<body>
	...
	<hr/>
	<?php 
	$data_siswa = $koneksi->query("SELECT * FROM siswa
	join kelas on kelas.id_kelas=siswa.id_kelas WHERE nisn='$_GET[nisn]' ");
	$sw = mysqli_fetch_assoc($data_siswa);
	...
	<?php 
	$pembayaran = mysqli_query($koneksi,"SELECT pembayaran.nobayar,pembayaran.bulan,pembayaran.jumlah, pembayaran.ket,siswa.nisn,siswa.nama, siswa.id_kelas
	...
	$i=1;
	$total = 0;
	while($dta=mysqli_fetch_assoc($pembayaran)) :
	 ?>
	<tr>
